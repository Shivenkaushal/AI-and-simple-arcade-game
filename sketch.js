   ...
   gameState="end"
    ...
    if(gameState === "play"){
      intros.hide();
        ...
        if(touches.length > 0 || noseY < 100 && gameplay === "facecontrol"){
            player.y = player.y - 15;
            touches = [];
        }

        if(touches.length > 0 || keyDown(UP_ARROW) && gameplay === "simple"){
          player.y = player.y - 15;
          touches = [];
      }
        ...
        if(touches.length > 0 || noseX > 200 && gameplay === "facecontrol" ){
            player.x = player.x + 10;
            player.addImage("player", player_img1);
            touches = [];
        }

        if(touches.length > 0 || keyDown(RIGHT_ARROW) && gameplay === "simple" ){
          player.x = player.x + 10;
          player.addImage("player", player_img1);
          touches = [];
      } 
      ...
      if(touches.length > 0 || keyDown(LEFT_ARROW) && gameplay === "simple"){
        player.x = player.x - 10;
        player.addImage("player", player_img2);
        touches = [];
    }
